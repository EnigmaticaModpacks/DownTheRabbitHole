...
$MODPACK_NAME = "DownTheRabbitHole"

# Name of the Modpack in the ZIP File
$CLIENT_NAME = "DownTheRabbitHole"
...
$CLIENT_FILE_DISPLAY_NAME = "Down The Rabbit Hole $MODPACK_VERSION"
...
$SERVER_FILE_DISPLAY_NAME = "Down The Rabbit Hole Server $MODPACK_VERSION"
